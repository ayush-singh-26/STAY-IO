...
import { cancelBooking, checkAvailabilityApi, createBooking, getHotelBooking, getUserBookings } from "../controllers/booking.controller.js";
...
router.route('/cancel-booking/:bookingId').patch(verifyJWT,cancelBooking);
