        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-800">{dashboardDummyData.totalBookings}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-green-50 mr-4">
              {/* Replace with your revenue icon */}
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-800">${dashboardDummyData.totalRevenue.toLocaleString()}</p>
            </div>
          </div>
        </div>
      </div>
